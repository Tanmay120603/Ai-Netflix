...
function MovieTitle({original_title,overview}){
    ...
    return(
        <div className="flex flex-col justify-center md:justify-normal gap-3 md:pt-[18%] pl-16 absolute w-[100%] h-screen bg-gradient-to-r from-slate-950 text-white">
            <h1 className="font-bold text-4xl">{original_title}</h1>
            <p className="hidden md:w-4/12 md:block">{overview}</p>
